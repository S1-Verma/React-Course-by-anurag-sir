        ...
        return (
            <div className="flex flex-col items-center justify-center gap-1 ">
                ...
                <div className=' flex items-center '>
                    <button onClick={this.decreseCount} className=' border-2 cursor-pointer p-1 rounded-2xl  font-normal '>Count -</button>
                    <p className=' border-2 p-1 rounded-2xl m-4 w-20'>{this.state.count}</p>
                    <button onClick={ function () {
                        this.setState({ count: this.state.count + 1 })
                    }.bind(this) // ab yaha par humne bind ka unse kiya he jisse is function ko this ka access mil gaya he  
